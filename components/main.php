    <div class="slider d-xs-none d-sm-none d-md-block bvi-hide">
        <div id="mainSlider" class="carousel slide carousel-fade" data-bs-ride="carousel">
          <div class="carousel-indicators">
              ...
              <button type="button" data-bs-target="#mainSlider" data-bs-slide-to="6" aria-label="Slide 7"></button>
              <button type="button" data-bs-target="#mainSlider" data-bs-slide-to="7" aria-label="Slide 8"></button>
            </div>
    ...
    <div class="main-content">
      <div class="welcome text-16 conteiner">
        <diw class="row">
          ...
          <div class="speech col-sm-12 col-md-12 col-lg-9 col-xl-9 col-xxl-9">
			  	  <h5>Уважаемые друзья!</h5>
			  	  <p>Я рада приветствовать вас на официальном сайте ГБПОУ НАО «Ненецкий аграрно-экономический техникум»!<br>После образования в 1929 году Ненецкого национального округа встал вопрос о подготовке кадров для всех отраслей народного хозяйства, особенно для ведущей – оленеводства. Так, в 1932 году была образована сельскохозяйственная школа «Совхозуч» для обучения кадров оленеводческих колхозов: начальников стад, пастухов, чумработниц. Сегодня наш техникум является лидером в разработке и реализации стратегии развития образовательной организации и повышения качества образования в Ненецком автономном округе. <a href="/index.php?option=com_content&amp;view=article&amp;id=65&amp;Itemid=171">Далее...</a></p>
			    </div>
        </diw>
